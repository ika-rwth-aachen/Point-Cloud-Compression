...
class EncoderRNN(Layer):
    ...
    def __init__(self, bottleneck, name=None):
        ...
        self.RnnConv_e2 = RnnConv("RnnConv_e2", 64, (2, 2), kernel_size=(3, 3), hidden_kernel_size=(3, 3))
        self.RnnConv_e3 = RnnConv("RnnConv_e3", 128, (2, 2), kernel_size=(3, 3), hidden_kernel_size=(3, 3))
...
class DecoderRNN(Layer):
    ...
    def __init__(self, name=None):
        ...
        self.RnnConv_d4 = RnnConv("RnnConv_d4", 64, (1, 1), kernel_size=(3, 3), hidden_kernel_size=(3, 3))
...
class EncoderModel(Model):
    ...
    def call(self, inputs, training=False):
        ...
        hidden_e2 = self.initial_hidden(batch_size, [8, self.DIM2], 64)
        hidden_e3 = self.initial_hidden(batch_size, [4, self.DIM3], 64)
        hidden_e4 = self.initial_hidden(batch_size, [2, self.DIM4], 128)
        hidden_d2 = self.initial_hidden(batch_size, [2, self.DIM4], 128)
        hidden_d3 = self.initial_hidden(batch_size, [4, self.DIM3], 128)
        hidden_d4 = self.initial_hidden(batch_size, [8, self.DIM2], 64)
